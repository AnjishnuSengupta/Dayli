...
// or falling back to default development config
...
console.log('Firebase initialization with config:', {
  apiKey: firebaseConfig.apiKey ? 'API key provided' : 'No API key',
